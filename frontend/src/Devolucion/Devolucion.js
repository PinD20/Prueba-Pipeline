...
const Devolucion = () => {
  ...
  useEffect(() => {
    ...
    const obtenerVehiculos = async () => {
      try {
        //get de carros
        const response = await fetch(`http://localhost:5000/devolucion/${userId}`, {
          method: 'GET',
          headers: headers,
        });
  ...
  return (
    <>
      <div className="container mt-5">
        <h1 className="mb-4">Vehiculos Alquilados</h1>
            ...
            <div className="col-md-4 mb-4" key={index}>
              <Card>
                <Card.Body>
                  ...
                  <Card.Subtitle style={{ color: 'red', fontWeight: 'bold', textAlign: 'center'}}>
                    {'DEVOLVER'}
                  </Card.Subtitle>
                  <br />
