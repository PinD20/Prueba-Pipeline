...
function RegistroCliente() {
  ...
  const [numero_licencia, setNumLicencia] = useState('');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Maneja errores en la respuesta aquí
      }
    } catch (error) {
              ...
              <form id="registrationForm" onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                  ...
                  <input
                    ...
                    onChange={(e) => setFn(e.target.value.toString())}
                    required
                    />
                </div>
                
                <div className="mb-3">
                  <label htmlFor="numeroLicencia" className="form-label">Numero de licencia</label>
                  <input
                    maxLength={30}
                    type="number"
                    className="form-control"
                    ...
                    onChange={(e) => setNumLicencia(e.target.value.toString())}
                    required
                    />
                </div>                
                <div className="mb-3">
                  <label htmlFor="direccion" className="form-label">Dirección de la empresa</label>
                  <input
                    maxLength={50}
                    type="text"
                    className="form-control"
